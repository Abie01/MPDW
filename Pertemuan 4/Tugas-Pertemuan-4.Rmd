...
plot(y=ma2_sim[-1], x=yt1.ma2_sim, main="Scatterplot Autokorelasi MA(2) arima.sim",col="red",xlab="Yt-1",ylab="Yt")
## Yt-2 vs Yt
...
Autokorelasi teoretis:
$$ \psi_1 = \phi_1+\theta_1= 0.5+0.4=0.9  $$
$$ \psi_2 = \phi_1\psi_1+\phi_2+\theta_2= (0.5)(0.9)+0.2+0.6=1.25 $$
$$ \psi_3 = \phi_1\psi_2+\phi_2\psi_1= (0.5)(1.25)+(0.2)(0.9)=0.805 $$
